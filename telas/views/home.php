...
<div class="container-fluid d-flex justify-content-center align-items-center" style="height: calc(100vh - 70px); background-color: #d9ccf3;">
    <div class="row bg-white rounded-3 shadow" style="max-width: 960px; width: 100%; overflow: hidden;">
        ...
        <div class="col-md-6 d-flex flex-column align-items-center justify-content-center py-5" style="background-color:rgba(194, 168, 239, 0.81);">
            <h2 class="fw-bold mb-4" style="color:rgb(110, 70, 155);">Bem vindo(a)!</h2>
            <button class="btn btn-lg text-white mb-3 w-75" style="background-color:rgb(167, 104, 226); border-radius: 10px;" onclick="window.location.href='login.php'">Fazer login</button>
